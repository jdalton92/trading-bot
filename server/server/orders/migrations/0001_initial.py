# Generated by Django 3.1.3 on 2020-12-06 04:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('assets', '0011_auto_20201206_0452'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stop_price', models.DecimalField(decimal_places=5, max_digits=12, verbose_name='stop price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('limit_price', models.DecimalField(decimal_places=5, max_digits=12, verbose_name='limit price')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('open', 'open'), ('closed', 'closed')], max_length=56, verbose_name='status')),
                ...
                ('order_class', models.CharField(choices=[('simple', 'simple'), ('bracket', 'bracket'), ('oco', 'one cancels other'), ('oto', 'one triggers other')], max_length=56, verbose_name='order class')),
                ('stop_loss', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='orders.stoploss', verbose_name='stop loss')),
                ...
                ('take_profit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='orders.takeprofit', verbose_name='take profit')),
            ],
            options={
                'verbose_name': 'order',
