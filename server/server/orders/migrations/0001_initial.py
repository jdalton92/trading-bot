# Generated by Django 3.1.3 on 2021-01-27 10:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replaced_by', models.UUIDField(blank=True,
                                                 editable=False, null=True, unique=True)),
                ('replaces', models.UUIDField(blank=True,
                                              editable=False, null=True, unique=True)),
                ...
                ('hwm', models.DecimalField(decimal_places=5,
                                            max_digits=12, verbose_name='hwm')),
                ('asset_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='orders', to='assets.assetclass', verbose_name='asset class')),
                ('asset_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                               related_name='+', to='assets.asset', verbose_name='asset id')),
                ('legs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                ...
                ('symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                             related_name='orders', to='assets.asset', verbose_name='symbol')),
