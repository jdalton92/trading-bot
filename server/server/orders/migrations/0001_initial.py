# Generated by Django 3.1.3 on 2020-12-08 10:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_order_id', models.UUIDField(blank=True, editable=False, null=True, unique=True)),
                ...
                ('stop_loss', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='orders.stoploss', verbose_name='stop loss')),
                ...
                ('take_profit', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='orders.takeprofit', verbose_name='take profit')),
            ],
            options={
                'verbose_name': 'order',
