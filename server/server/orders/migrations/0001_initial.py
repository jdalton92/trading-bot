    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "filled_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="filled"),
                ),
                (
                    "expired_at",
                ...
                (
                    "failed_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="failed"),
                ),
                (
                    "replaced_at",
                    models.DateTimeField(
                ...
                (
                    "qty",
                    models.DecimalField(
                        decimal_places=5, max_digits=12, verbose_name="quantity"
                    ),
                ),
                (
                    "filled_qty",
                    models.DecimalField(
                        decimal_places=5, max_digits=12, verbose_name="filled quantity"
                    ),
                ),
                (
                    "type",
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=12,
                        null=True,
                        verbose_name="filled average price",
                    ),
                ),
                (
                    "status",
