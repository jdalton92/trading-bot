...
from server.orders.serializers import (
...
class OrderSerializerTests(TestCase):
    ...
    def test_post_order(self):
        ...
        data = {
            ...
            "stop_loss": {"stop_price": 100.01, "limit_price": 100.05},
        }

        serializer = OrderPostSerializer(data=data, context={"request": self.request})
    ...
    def test_view_order(self):
        ...
        data = OrderSerializer(order, context={"request": self.request}).data

        self.assertEqual(
            data["user"],
            UserSerializer(self.user, fields=("id", "first_name", "last_name")).data,
        )
    ...
    def test_create_order(self):
        ...
        data = {
            ...
            "legs": [self.order_3.pk, self.order_4.pk],
            "qty": 100,
            "filled_qty": 100,
            "type": Order.MARKET,
            "side": Order.BUY,
