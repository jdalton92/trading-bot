...
from server.assets.serializers import (
...
from .factories import AssetClassFactory, AssetFactory, BarFactory, ExchangeFactory
...
class ExchangeSerializerTests(TestCase):
    ...
    def test_view_exchange(self):
        ...
        data = ExchangeSerializer(exchange, context={"request": self.request}).data
    ...
    def test_create_exchange(self):
        ...
        serializer = ExchangeSerializer(data=data, context={"request": self.request})
...
class AssetClassSerializerTests(TestCase):
    ...
    def test_view_asset_class(self):
        ...
        data = AssetClassSerializer(asset_class, context={"request": self.request}).data
    ...
    def test_create_asset_class(self):
        ...
        serializer = AssetClassSerializer(data=data, context={"request": self.request})
        self.assertTrue(serializer.is_valid())
...
class AssetSerializerTests(TestCase):
    ...
    def test_view_asset(self):
        ...
        asset = AssetFactory(asset_class=self.asset_class, exchange=self.exchange)
    ...
    def test_create_asset(self):
        ...
        serializer = AssetSerializer(data=data, context={"request": self.request})
        self.assertTrue(serializer.is_valid())
    ...
    def test_update_asset(self):
        ...
        asset = AssetFactory(
            name="Old Asset Name", asset_class=self.asset_class, exchange=self.exchange
        )
...
class BarSerializerTests(TestCase):
    ...
    def test_create_bar(self):
        ...
        serializer = BarSerializer(
            data=data, context={"request": self.request, "asset_id": self.asset.id}
        )
